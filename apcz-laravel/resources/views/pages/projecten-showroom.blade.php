  ...
  <div class="container">
    <div class="stack">
      ...
      <p class="p" style="max-width:980px;">
        Hieronder staan placeholders zodat de pagina gevuld is. Later vervang je dit simpel door je eigen foto’s in <code>public/assets/img</code>.
      </p>
